...
const Hero = () => {
  ...
  return (
    ...
    <motion.div
      ...
      <div>
        <h1 className="lg:text-7xl text-4xl font-bold font-serif bg-gradient-to-r from-white to-blue-500 bg-clip-text text-transparent ">Striving for <br/> 
        ...
        <div className="relative flex flex-cols xl:w-1/2">
          <h1 className="text-xl lg:text-2xl text-yellow-400 lg:bold-22 font-sans py-5 lg:mt-10 mb-10" >You understand your customers better than anyone. We know that, and we can help you turn that knowledge into results.</h1>
        </div>
      </div>
