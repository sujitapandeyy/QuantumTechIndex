...
<h1 className="text-xl font-bold text-yellow-500  font-sans p-5">
  What we do
      ...
      <h1 className="font-bold text-4xl lg:text-7xl lg:bold-99 font-serif bg-gradient-to-r from-white to-blue-500 bg-clip-text text-transparent ">
      Our Driving
Services
</h1>
      </div>
   ...
   <div className="flex flex-col-reverse md:flex-row items-center justify-center gap-4">
            ...
            <div className="w-full md:w-1/2 p-4">
             <h1 className="lg:text-2xl text-xl font-bold text-yellow-600  pt-10">Web Development</h1>
               <p className="lg:text-md text-sm text-gray-500 pt-2">
                  We mainly deal with building and designing websites, which includes coding and writing markup ranging from creating plain text pages to complex web-based applications, social network applications, and electronic business applications.
               </p>
             </div>
           ...
           <div className="flex flex-col-reverse md:flex-row items-center justify-center gap-4">
            <div className="w-full md:w-1/2 p-4">
             <h1 className="lg:text-2xl text-xl font-bold text-yellow-600 pt-10">Application Development</h1>
               <p className="lg:text-md text-sm text-gray-500 pt-2">
               We create a mobile application or a set of programs to perform the different tasks that a business requires. From calculating monthly expenses to scheduling sales reports, applications help businesses automate processes and increase efficiency               </p>
             </div>
            <div className="w-4/5 md:w-1/3 lg:w-4/4 relative">
          ...
          className="relative flex justify-center items-center">
            ...
            <div className="w-full md:w-1/2 p-4">
             <h1 className="lg:text-2xl text-xl font-bold text-yellow-600 pt-10">Machine Development</h1>
               <p className="lg:text-md text-sm text-gray-500 pt-2">
               We deal with an application of AI that includes algorithms that parse data, learn from that data, and then apply what they’ve learned to make informed decisions as well as to manage data and information               </p>
             </div>
          ...
          <div className="flex flex-col-reverse md:flex-row items-center justify-center gap-4">
            <div className="w-full md:w-1/2 p-4">
             <h1 className="lg:text-2xl text-xl font-bold text-yellow-600 pt-10">WordPress Development</h1>
               <p className="lg:text-md text-sm text-gray-500 pt-2">
               We deal with developing and publishing software that can be installed locally on a web server and viewed on a proprietary web site or hosted in the cloud and viewed on the WordPress web site               </p>
             </div>
            <div className="w-4/5 md:w-1/3 lg:w-4/4 relative">
