  ...
  return (
   ...
   <div style={{ backgroundImage: 'url("/main5.png")',backgroundSize: 'cover', 
    ...
    CONTACT US
          ...
          <h1 className="text-4xl lg:text-7xl lg:font-bold font-serif bg-gradient-to-r from-white to-blue-500 bg-clip-text text-transparent ">
    Send Your Message
    </h1>
          </div>
          </div>
...
class='container mx-auto'>
    ...
    <h2 class="text-md font-bold text-gray-800 justify-center flex mt-6 p-6">Write your message here</h2>
        <input type="text" name="name" placeholder="Your Name" required class="border rounded py-2 px-4 focus:outline-none focus:border-gray-600 transition duration-300 ease-in-out"/>
        <input type="email" name="email" placeholder="Your Email" required class="border rounded py-2 px-4 focus:outline-none focus:border-gray-400 transition duration-300 ease-in-out"/>
        <textarea name="project" cols="10" rows="2" placeholder="Project Description" required class="border rounded py-2 px-4 focus:outline-none focus:border-gray-400 transition duration-300 ease-in-out"></textarea>
        <button class="bg-gray-800 hover:bg-gray-900 text-white font-bold py-2 px-4 rounded-full transition duration-300 ease-in-out" type="submit" name="submit">Submit</button>
    </form>
</motion.div>
...
<section className="container mx-auto py-12">
  ...
  >
      ...
      className="grid grid-cols-1 p-10 md:grid-cols-3 gap-8">
