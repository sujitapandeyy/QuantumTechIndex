...
<div style={{ backgroundImage: 'url("/main5.png")',backgroundSize: 'cover', 
  ...
  <motion.div
    ...
    <div className="relative lg:flex">
      ...
      <Link href="https://www.realdaam.com/" target="_blank" rel="noopener noreferrer"className="absolute w-[15%]  absolute right-[850px] top-[230px] bg-blue-500 hover:bg-blue-700 text-white  font-bold py-4 px-5 rounded-full">
